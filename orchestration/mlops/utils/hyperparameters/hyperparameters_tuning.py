...
class XGBoostFinetuner:
    ...
    def finetune(
        ...
        for i, (rmse, pipeline, params) in enumerate(sorted(self.best_models, key=lambda x: x[0])):
        ...
        print(f"Access Top {self.n_best_models} performing models from object.best_models")