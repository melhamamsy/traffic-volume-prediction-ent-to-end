...
def setup(*args, **kwargs):
    ...
    if not policy_exists_by_name(POLICY_NAME_TERRAFORM_APPLY_DEPLOY_MAGE, aws_profile):
        ...
        print(f"Successfully created the policy '{POLICY_NAME_TERRAFORM_APPLY_DEPLOY_MAGE}'.")
    else:
        print(f"The policy '{POLICY_NAME_TERRAFORM_APPLY_DEPLOY_MAGE}' already exists.")
    if not policy_exists_by_name(POLICY_NAME_TERRAFORM_DESTROY_DELETE_RESOURCES, aws_profile):
        terraform_destroy_policy_arn = create_policy(
            POLICY_NAME_TERRAFORM_DESTROY_DELETE_RESOURCES, TERRAFORM_DESTROY_URL
        )
        print(f"Successfully created the policy '{POLICY_NAME_TERRAFORM_DESTROY_DELETE_RESOURCES}'.")
    else:
        print(f"The policy '{POLICY_NAME_TERRAFORM_DESTROY_DELETE_RESOURCES}' already exists.")
